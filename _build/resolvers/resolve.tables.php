...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('visualfilter_core_path', null, $modx->getOption('core_path') . 'components/visualfilter/') . 'model/';
            $modx->addPackage('visualfilter', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/visualfilter/model/schema/visualfilter.mysql.schema.xml';
